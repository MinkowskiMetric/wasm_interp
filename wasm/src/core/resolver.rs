...
pub trait Resolver {
    ...
    ) -> io::Result<core::RcCallable>;
    fn resolve_table(
        &self,
        mod_name: &str,
        name: &str,
        table_type: &core::TableType,
    ) -> io::Result<core::RcTable>;
    fn resolve_memory(
        &self,
        mod_name: &str,
        name: &str,
        mem_type: &core::MemType,
    ) -> io::Result<core::RcMemory>;
    fn resolve_global(
        &self,
        mod_name: &str,
        name: &str,
        global_type: &core::GlobalType,
    ) -> io::Result<core::RcGlobal>;
}
...
impl Resolver for EmptyResolver {
    fn resolve_function(
        ...
        Ok(std::rc::Rc::new(core::DummyCallable::new(
    ...
    fn resolve_global(
        ...
        Ok(std::rc::Rc::new(core::Global::new_dummy(
            global_type.clone(),
        )))
    }
}
